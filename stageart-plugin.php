...
define('STAGEART_PLUGIN_VERSION', '0.1.0');
...
register_activation_hook(STAGEART_PLUGIN_FILE, [
    StageArtPlugIn\Infrastructure\Schema\Schema::class,
    'activate',
]);

add_action('plugins_loaded', static function (): void {
    (new StageArtPlugIn\Plugin())->boot();
});
